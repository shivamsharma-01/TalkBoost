...
const Home = () => {
    return (
        <div>
            <div className="min-h-screen bg-linear-to-r  bg-[#83715c] text-white overflow-hidden">
                ...
                <section className="relative z-10 flex flex-col items-center justify-center text-center px-6 pt-20 md:pt-28">
                    ...
                    >
                        ...
                        <h1 className="text-[#fed7aa] text-4xl md:text-7xl font-bold leading-tight max-w-4xl tracking-tight">
                            <span className='text-[#0f172a]'>S</span><span className='text-[#1e293b]'>p</span><span className='text-[#334155]'>e</span><span className='text-[#475569]'>a</span><span className='text-[#64748b]'>k</span> <span className='text-[#475569]'>English</span>
                            <br />
                            <span className=" text-[#083344]" >Confidently</span>
                        </h1>
                    </motion.div>
